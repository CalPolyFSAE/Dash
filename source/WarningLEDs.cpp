...
void setLED2() {
	gpio::GPIO::StaticClass().set(gpio::PortD,6);
}
void setLED3() {
	gpio::GPIO::StaticClass().set(gpio::PortD,5);
}
void setLED4() {
	gpio::GPIO::StaticClass().set(gpio::PortB,4);
}
...
void clearLED2() {
	gpio::GPIO::StaticClass().clear(gpio::PortD,6);
}
void clearLED3() {
	gpio::GPIO::StaticClass().clear(gpio::PortD,5);
}
void clearLED4() {
	gpio::GPIO::StaticClass().clear(gpio::PortB,4);
}
